...
export function buildGeminiResearchPrompt({ fixture, competition, market, selection = null, competitiveContext = null, oddsQuote, verifiedData = [], missingData = [], risks = [], analyzedAt = new Date().toISOString() }) {
  ...
  return [
    ...
    "Si tienes disponible una función de búsqueda o navegación web en esta sesión, úsala para verificar cada hecho.",
    "No asumas ni afirmes tener acceso a navegación si no está disponible: en ese caso, responde solo con lo que puedas verificar de otro modo y marca el resto como NO VERIFICADO.",
    ...
    "Si no puedes verificar un dato con información actual, decláralo explícitamente como NO VERIFICADO en vez de omitirlo en silencio.",
    "",
