...
## Rutas pendientes de consolidación
...
La capacidad útil se migrará a las rutas versionadas `fixtures` y `leagues`, con contratos sanitizados. Después se retirarán las dos rutas duplicadas no versionadas.
